...
mlflow.set_experiment("Lesson_3")
...
def get_paths(date):
    ...
    train_path = '/Users/agvg/Documents/DS/MLOPS/MLOPS/Class 3/fhv_tripdata_'+date_train+'.parquet'
    val_path = '/Users/agvg/Documents/DS/MLOPS/MLOPS/Class 3/fhv_tripdata_'+date_val+'.parquet'     
